        ...
        <div>
            ...
            <div className='container col-sm-12 col-md-6 col-lg-3 mt-3' >
                ...
                <form onSubmit={cadastrarAula}>
                    ...
                    <input className='form-control' type="date" name="" id="" value={turma} onChange={(e) => (setTurma(e.target.value))} />

                    <label className='form-label' htmlFor="">Instrutor:</label>
                    <input className='form-control' type="date" name="" id="" value={instrutor} onChange={(e) => (setInstrutor(e.target.value))} />

                    <label className='form-label' htmlFor="">Unidade Curricurilar:</label>
                    <input className='form-control' type="date" name="" id="" value={unidadeCurricular} onChange={(e) => (setUnidadeCurricular(e.target.value))} />

                    <label className='form-label' htmlFor="">Ambiente:</label>
                    <input className='form-control' type="date" name="" id="" value={ambiente} onChange={(e) => (setUnidadeCurricular(e.target.value))} />
